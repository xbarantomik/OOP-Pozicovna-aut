...
public class AYSOrderView extends Application{
	...
	private void setLayout() {	
		...
		SummaryLb.setFont(new Font("Cambria", 30));
		...
		CarLb.setFont(new Font("Cambria", 22));
		...
		CarConstLb.setFont(new Font("Cambria", 22));
		...
		PriceLb.setFont(new Font("Cambria", 22));
		...
		PriceConstLb.setFont(new Font("Cambria", 22));
		...
		CreditLb.setFont(new Font("Cambria", 22));
		...
		CreditConstLb.setFont(new Font("Cambria", 22));
		...
		DepositLb.setFont(new Font("Cambria", 22));
		...
		DepositConstLb.setFont(new Font("Cambria", 22));
		...
		OverallLb.setFont(new Font("Cambria", 22));
		...
		OverallConstLb.setFont(new Font("Cambria", 22));
		...
		SeparatorLb.setFont(new Font("Cambria", 22));
		...
		OrderBtn.setFont(new Font("Cambria", 23));
		...
		NotEnoughCreditLb.setFont(new Font("Cambria", 22));
		...
		ForDaysLb.setFont(new Font("Cambria", 22));
		...
		HiddenIDLb.setFont(new Font("Cambria", 22));
		...
		try {
			...
			OrderBtn.setOnAction(e -> {
				try {
					...
					System.out.println("ERROR OrderBtn v AreYouSure View");
					e3.printStackTrace();
